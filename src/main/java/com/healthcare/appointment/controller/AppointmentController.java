...
public class AppointmentController {
    ...
    public ResponseEntity<?> bookAppointment(@RequestBody Map<String, Object> request) {
        ...
        try {
            appointmentDateTime = LocalDateTime.parse(appointmentTime);
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(Map.of("message", "Invalid date/time format. Use YYYY-MM-DDTHH:MM"));
        }
